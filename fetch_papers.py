...
if __name__ == "__main__":
  ...
  # econ.EM, econ.GN, econ.TH, stat.AP, q-fin.EC, q-fin.GN, q-fin.ST (Economics)
  # q-bio.NC, q-bio.QM, q-bio.GN, q-bio.BM (Biology)

  # parse input arguments
  parser = argparse.ArgumentParser()
  parser.add_argument('--search-query', type=str,
                      default='cat:econ.EM+OR+cat:econ.GN+OR+cat:econ.TH+OR+cat:stat.AP+OR+cat:q-fin.EC+OR+cat:q-fin.ST',
                      help='query used for arxiv API. See http://arxiv.org/help/api/user-manual#detailed_examples')
  parser.add_argument('--start-index', type=int, default=0, help='0 = most recent API result')
  parser.add_argument('--max-index', type=int, default=2000, help='upper bound on paper index we will fetch')
